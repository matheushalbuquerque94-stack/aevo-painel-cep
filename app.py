    ...
    html+=('<div class="capa">'
      ...
      '<div class="capa-right"><div class="capa-card">'
        '<div class="kpi-main">'
          ...
          '<div><span class="kval" contenteditable="true">'+er_s+'</span><span class="kunt">kWh</span></div>'
          '<div class="kref" contenteditable="true">Esperado PVsyst: '+ee_s+' kWh</div>'
        '</div>'
        '<div class="badges-grid">'
          '<div class="badge-kpi"><div class="bl">Atingimento</div><div class="bv" contenteditable="true">'+at_s+'</div></div>'
          '<div class="badge-kpi"><div class="bl">PR Real</div><div class="bv" contenteditable="true">'+pr_s+'</div></div>'
          '<div class="badge-kpi"><div class="bl">Disp. Operação</div><div class="bv" contenteditable="true">'+pct_ger_s+'</div></div>'
          '<div class="badge-kpi"><div class="bl">Cobertura</div><div class="bv" contenteditable="true">'+cob_s+'</div></div>'
        '</div>'
          ...
          '<div class="panel"><div class="panel-title" contenteditable="true">Resultado Operacional</div>'
            '<div class="kpi-3">'
              '<div class="kpi or"><div class="lbl" contenteditable="true">Energia Real</div>'
                '<div class="val" contenteditable="true">'+er_s+'</div><div class="unit">kWh</div>'
              ...
              '<div class="kpi yw"><div class="lbl" contenteditable="true">Atingimento</div>'
                '<div class="val" contenteditable="true">'+at_s+'</div>'
              ...
              '<div class="kpi gn"><div class="lbl" contenteditable="true">PR Real</div>'
                '<div class="val" contenteditable="true">'+pr_s+'</div><div class="unit">Performance Ratio</div>'
          ...
          '<div class="panel"><div class="panel-title" contenteditable="true">Qualidade e Disponibilidade</div>'
            '<div class="kpi-2">'
              '<div class="kpi gn"><div class="lbl" contenteditable="true">Cobertura de Dados</div>'
                '<div class="val sm" contenteditable="true">'+fmt_p(cob_pct)+'</div>'
              ...
              '<div class="kpi bu"><div class="lbl" contenteditable="true">Disp. Geração</div>'
                '<div class="val sm" contenteditable="true">'+pct_ger_s+'</div>'
          ...
          '<div class="panel"><div class="panel-title" contenteditable="true">Contexto Financeiro e Recurso</div>'
            '<div class="kpi-2">'
              '<div class="kpi pu"><div class="lbl" contenteditable="true">Receita Estimada</div>'
                '<div class="val sm" contenteditable="true">'+rec_s+'</div>'
    ...
    if is_tier1:
        ...
        html+=('<div class="pag">'
          ...
          '<div style="display:grid;grid-template-columns:repeat(7,1fr);gap:4px;flex-shrink:0">'
            '<div class="kpi gn"><div class="lbl">Disp. Geração</div><div class="val sm" style="color:#2CA66F">'+pct_ger_s+'</div></div>'
            '<div class="kpi bu"><div class="lbl">Perdas Concess.</div><div class="val sm" style="color:#0F9ED5">'+pct_conc_s+'</div></div>'
            '<div class="kpi" style="border-top-color:#E45C54"><div class="lbl">Perdas Eq./O&amp;M</div><div class="val sm" style="color:#E45C54">'+pct_om_s+'</div></div>'
            ''
            '<div class="kpi or"><div class="lbl">Total Eventos</div><div class="val sm" style="color:#E97132">'+str(total_ev)+'</div></div>'
            ...
            '<div class="kpi" style="border-top-color:#0E2841"><div class="lbl">Total Horas OFF</div><div class="val sm">'+fmt_n(total_h,2)+' h</div></div>'
          '</div>'
